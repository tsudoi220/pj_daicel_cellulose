    ...
    <section className={"message" + (classNames ? ` ${classNames}` : "")} >
      <div className="message_inner">
        ...
        <div className="message_body">
          ...
          <Text classNames="message_text _center _wide _large" data-scroll-animation>
            木から生まれる歴史ある素材、<br className="_sp" />
            セルロース。<br />
            最大の特徴は、人が栽培できる<br className="_sp" />
            資源だということ。<br />
            栽培できる、つまり循環サイクルを<br className="_sp" />
            コントロールできるのです。<br />
            さらに海に流れ出るものは<br className="_sp" />
            分解しやすくするなど、<br />
            目的に合わせて特性を<br className="_sp" />
            デザインすることも可能です。<br />
            100年かけて磨き上げた、<br className="_sp" />
            ダイセルのセルロース。
          </Text>
          <Text classNames="message_text _center _wide _large" data-scroll-animation>
            昔からある未来の素材で、<br />
            人類に立ちはだかる問題に<br className="_sp" />
            挑みます。
          </Text>
