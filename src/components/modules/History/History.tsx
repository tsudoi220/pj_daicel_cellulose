        ...
        <div className="history_items">
          ...
          <div className="history_item" data-scroll-animation>
            <HistoryItem
              ...
              year="2019"
              text={`針を用いずに高速ジェット流で瞬時に皮膚を穿孔して細胞内へ物質を導入する動物実験用新規投与デバイス「アクトランザ®ラボ」。遺伝子治療薬など革新的な医薬品の実現につながるドラッグデリバリーシステムには、硝酸セルロースから始まるガス発生器の技術で独自のエネルギーシステム DAISI®が使われています。`}
            />
          </div>
          <div className="history_item" data-scroll-animation>
            <HistoryItem
