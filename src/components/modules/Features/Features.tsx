  ...
  return (
    <section className={"features" + (classNames ? ` ${classNames}` : "")} >
      <div className="features_head">
        <Heading as="h3" classNames="features_heading _features" data-scroll-animation>セルロースの主な性質</Heading>
        <Text classNames="features_text _center" data-scroll-animation>植物由来の成分であるセルロースには、<br className="_sp"/>さまざまな性質があります。</Text>
      </div>
