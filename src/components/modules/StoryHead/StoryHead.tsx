  ...
  return (
    <div className={"storyHead" + (classNames ? ` ${classNames}` : "")} >
      <div className="storyHead_inner">
        ...
        <Text classNames="storyHead_text _center _wide-s _storyHead" data-scroll-animation>私たちは創業から< br className="_sp" />100年以上にわたり、< br className="_sp" />セルロースの研究・開発を進め、<br />
