  ...
  return (
    <section className={"valueChain" + (classNames ? ` ${classNames}` : "")} >
      <div className="valueChain_inner">
        ...
        <Text classNames="valueChain_text" data-scroll-animation>私たちは、ダイセルは、セルロースを扱う技術を軸に、持続可能な循環型の産業構造をつくる「バイオマスバリューチェーン構想」を提唱しています。日本の国土の７割を占める森林を原料とし、化学産業だけでなく、幅広く一次産業・二次産業も連関し、地域経済を活性化させるこの構想の実現には、多くの共感と技術共有による共創を必要としています。</Text>
